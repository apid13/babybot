...
➸ *${prefix}ttp*
Text to sticker contoh : ${prefix}ttp FIDS
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo Bot
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig fidsbot_
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
...
➸ *${prefix}hartatahta*
Membuat lomgo, contoh : ${prefix}hartatahta fidsbot
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub Fids & Hub
